...
public class CadillacEnergyRangeGaugeBarView extends View {
    ...
    public CadillacEnergyRangeGaugeBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CadillacEnergyRangeGaugeBarView(Context context, AttributeSet attrs, int defStyleAttr) {
