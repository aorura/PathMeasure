...
import com.lge.vs.gaugebarlibrary.gaugebar.gmc.GaugeBarProgressBgPainterImp;
import com.lge.vs.gaugebarlibrary.gaugebar.gmc.GaugeBarProgressPainterImp;
import com.lge.vs.gaugebarlibrary.gaugebar.gmc.InsideLowRangeLinePainterImp;
import com.lge.vs.gaugebarlibrary.utils.EtcUtils;

public class GmcEnergyRangeGaugeBarView extends View {
    ...
    public GmcEnergyRangeGaugeBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public GmcEnergyRangeGaugeBarView(Context context, AttributeSet attrs, int defStyleAttr) {
